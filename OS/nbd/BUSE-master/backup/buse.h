...
struct buse_req
{
 ...
 {
    int (*read)(struct buse_req* requset_st , void *userdata);
    int (*write)(struct buse_req* requset_st, void *userdata);
...
void buseDone(struct buse_req *main_buse , int status); /*my functions*/
